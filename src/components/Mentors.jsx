export default function Mentors() {
  return (
    <div className="container mx-auto px-4">
      <h3 className="text-2xl sm:text-3xl font-semibold mb-2 text-center text-white">Meet our mentors</h3>
      <p className="text-neutral-400 text-center mb-8 text-sm">Learn from engineers who've shipped at Google, Apple, Microsoft, and more.</p>

      <Carousel images={MENTOR_IMAGES} />

      <section className="mt-14 md:mt-16">
        <h3 className="text-2xl sm:text-3xl font-semibold mb-6 text-center text-white">Community stories</h3>
        <div className="grid gap-6 md:grid-cols-3">
          <Card>
            ...
            <p className="mt-3 text-sm text-neutral-200/95">Jhanwwee showcased her skills in the Hiring Tournament and got referred to Amazon.</p>
          </Card>

          <Card>
            <User name="Polkam Srinidhi" date="Sep 2" />
            <p className="text-sm text-neutral-200/95">
            ...
            <a className="mt-3 inline-block text-xs text-neutral-300 hover:text-white transition" href="https://www.linkedin.com/feed/update/urn:li:activity:7234356533797511168/" target="_blank" rel="noreferrer">View on LinkedIn →</a>
          </Card>
          ...
          <Card>
            ...
            <p className="mt-3 text-sm text-neutral-200/95">Satvik on cracking product‑based companies and how the right mentorship accelerates growth.</p>
          </Card>
          ...
          <Card>
            ...
            <p className="mt-3 text-sm text-neutral-200/95">Aditi got placed at ADP as a fresher after impressing mentors at AUHT July Edition.</p>
          </Card>
          ...
          <Card>
            ...
            <a className="mt-3 inline-block text-xs text-neutral-300 hover:text-white transition" href="https://www.linkedin.com/feed/update/urn:li:activity:7234542677340405760/" target="_blank" rel="noreferrer">View on LinkedIn →</a>
          </Card>
          ...
          <Card>
            ...
            <a className="mt-3 inline-block text-xs text-neutral-300 hover:text-white transition" href="https://www.linkedin.com/feed/update/urn:li:activity:7291862499757375488/" target="_blank" rel="noreferrer">View on LinkedIn →</a>
          </Card>
        </div>
      </section>
    </div>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-4">
        <div className="mentor-viewport overflow-x-auto no-scrollbar">
          <ul className="mentor-track grid grid-flow-col auto-cols-[72%] sm:auto-cols-[42%] md:auto-cols-[28%] gap-4">
            {images.map((src, i) => (
              <li key={i} className="rounded-xl overflow-hidden border border-white/10 bg-neutral-900">
